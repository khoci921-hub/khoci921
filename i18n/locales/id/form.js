...
export const form = {
  form: {
    ...
    chat_missing_kelebihan: 'Kelebihan Sifat',
    chat_missing_kekurangan: 'Kekurangan Sifat',
    chat_missing_motivasi: 'Motivasi Ke Jepang',
    chat_missing_alasan: 'Alasan Memilih Bidang',
    chat_missing_rencana: 'Rencana Setelah Pulang',
    chat_missing_tujuan: 'Tujuan Kerja di Jepang',
    chat_missing_sertifikasi: 'Sertifikasi (JFT/SSW)',
